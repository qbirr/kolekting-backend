                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:125px;">
                                                                <img height="auto"
                                                                    src="{{ asset('storage/logo/gesslogo.png') }}" alt="GES Logo"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:center;color:#000000;">
                                                    Kami menerima permintaan reset password dari akun anda. Berikut adalah kode OTP yang diperlukan :</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center"
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:center;color:#000000;">
                                                    Silakan masukkan kode ini di aplikasi anda untuk melanjutkan proses reset password. Jika anda tidak
                    meminta reset password, harap abaikan email ini.</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center"
